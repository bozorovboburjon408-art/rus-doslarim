    ...
    content: [
      {
        ...
        rules: [
          ...
          "📌 Глаголы: быть, стать, являться, казаться, оказаться, называться",
      ...
      },
      {
        ...
        rules: [
          ...
          "📌 Глаголы: бояться, хотеть, желать, избегать, ждать, достигать, лишаться, касаться",
      ...
      },
      {
        ...
        rules: [
          ...
          "📌 Глаголы: давать, помогать, верить, отвечать, звонить, говорить, радоваться, удивляться",
      ...
      },
      {
        ...
        rules: [
          ...
          "📌 Глаголы: видеть, слышать, любить, знать, читать, писать, смотреть, ждать",
      ...
      },
      {
        ...
        rules: [
          ...
          "📌 Глаголы: владеть, управлять, интересоваться, заниматься, гордиться, пользоваться, быть",
      ...
      },
      {
        ...
        rules: [
          ...
          "📌 Глаголы: думать (о), говорить (о), мечтать (о), заботиться (о), жить (в/на), работать (в/на)",
