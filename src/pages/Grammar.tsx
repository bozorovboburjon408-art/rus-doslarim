  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        colorIndex: 4,
        rules: [
          "Простое будущее (совершенный вид): Я прочитаю, ты прочитаешь, он прочитает",
          "Составное будущее (несовершенный вид): буду/будешь/будет + инфинитив",
          "Я: буду читать, буду писать",
          "Ты: будешь читать, будешь писать",
          "Он/она: будет читать, будет писать",
          "Мы: будем читать, будем писать",
          "Вы: будете читать, будете писать",
          "Они: будут читать, будут писать",
          "Например: Завтра я буду работать. Я прочитаю эту книгу.",
        ],
      },
    ],
  },
