...
export const notesData: Note[] = [
  {
    ...
    grammarTopic: "Фонетические и орфоэпические нормы русского языка",
    vocabulary: [
      { russian: "автобиография", uzbek: "tarjimaihol" },
      { russian: "год рождения", uzbek: "tug'ilgan yil" },
      { russian: "дружная семья", uzbek: "inoq oila" },
      { russian: "семейные традиции", uzbek: "oilaviy an'analar" },
      { russian: "благоустроенный город", uzbek: "obodlashtirilgan shahar" },
      { russian: "зелёные скверы и парки", uzbek: "ko'm-ko'k xiyobonlar va istirohat bog'lari" },
      { russian: "оазис", uzbek: "voha" },
      { russian: "упоминание", uzbek: "yodga olish" },
      { russian: "в глубь столетий", uzbek: "uzoq asrlarga" },
      { russian: "нынешнее название", uzbek: "hozirgi nomi" }
    ],
    grammarRules: [
      { rule: "Орфоэпические нормы - это произносительные правила устной речи", example: "Изучает раздел языкознания – орфоэпия (от греч. orthos – «правильный» и epos – «речь»)" },
      { rule: "Фонетика - это раздел науки о языке, изучающий звуковую сторону", example: "Состав звуков, особенности их произношения в словах, ударение, интонацию" },
      { rule: "В русском алфавите 33 буквы: 10 гласных, 21 согласная, ъ и ь", example: "А, Б, В, Г, Д, Е, Ё, Ж, З, И, Й, К, Л, М, Н, О, П, Р, С, Т, У, Ф, Х, Ц, Ч, Ш, Щ, Ъ, Ы, Ь, Э, Ю, Я" },
      { rule: "Звук – это наименьшая единица языка. Буква – это знак, который обозначает звук", example: "В русском языке 31 звук, 33 буквы" },
      { rule: "Графика – это совокупность особых знаков для передачи устной речи на письме", example: "Орфография – правильное написание слов" },
      { rule: "Акцентологические нормы устанавливают место ударения в словах", example: "водопровОд, мусоропровОд, каталОг, монолОг" },
      { rule: "Произношение чн как [шн]", example: "горчичник, конечно, скворечник, скучно, яичница" },
      { rule: "Разделительные ъ и ь пишутся после согласной перед е, ё, ю, я, и", example: "шьёт, съел, вьюга, подъезд" }
    ],
    exercises: [
      "Произнесите правильно слова: загнутый, вероисповедание, набок, вредна, черпать, мусоропровод, средства, поняла, включит",
      "Произнесите правильно: вечный – скучно; сердечный – пустячный; почта – чтобы; тема – теннис",
      "Определите какими членами предложения являются существительные в пословицах: 'Доброе дело в воде не утонет', 'Мудрость не нуждается в мудрой одежде'",
      "Найдите по словарю слова: языкознание, лингвистика, филология, факультет, деканат. Запишите их в алфавитном порядке",
      "Расскажите о себе по образцу: Меня зовут... Я родился в Узбекистане. Я учусь в... институте"
    ]
  },
  {
    id: 2,
